...
public class WalletAddressesAdapter extends BaseAdapter
{
	...
	public View getView(final int position, View row, final ViewGroup parent)
	{
		...
		row.setBackgroundResource(isDefaultAddress ? R.color.bg_list_selected : R.color.knc_background_darker);

		final TextView addressView = (TextView) row.findViewById(R.id.address_book_row_address);
		addressView.setText(WalletUtils.formatAddress(address, Constants.ADDRESS_FORMAT_GROUP_SIZE, 24));
		...
		final ImageView img = (ImageView) row.findViewById(R.id.address_book_contact_image);
